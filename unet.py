...
class UNet(nn.Module):
    def __init__(self, in_channels=3, out_channels=1, init_features=32):
        ...
        self.decoder_1 = Block(features * 2, features)
    ...
    def forward(self, x):
        ...
        conv_encoder_3_1 = self.conv_encoder_2(conv_encoder_2_2)
        conv_encoder_3_2 = nn.MaxPool2d(kernel_size=2,stride=2)(conv_encoder_3_1)

        conv_encoder_4_1 = self.conv_encoder_2(conv_encoder_3_2)
